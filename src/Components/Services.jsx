...
const Services = () => {
  return (
    ...
    <div className=' p-12 servicies '>
      <h1 className=' text-[#000000]  md:text-[1.8rem] text-center font-semibold sm:text-[1.8rem] xs:text-[1.5rem] text-[1.4rem] ' >
      ...
      <div className=' mt-20 flex flex-wrap gap-10 justify-center items-center ' >
        ...
        {service.map((service, index) => (
          ...
          <Tilt >
            <div className='w-full p-[.75rem] py-[15px] border-[2px] bg-white rounded-[5px] sm:w-[300px]
